...
smd({
  ...
  try {
    const response = await axios.get("https://api.github.com/repos/Reverseking1/ReverseKing");
    ...
    replyMessage += `**🍀Repository URL:** (https://github.com/Reverseking1/ReverseKing)\n`;
